...
const statusClass =
  ...
  return (
<div className="rounded-2xl border bg-white p-4 shadow-sm transition hover:shadow-xl hover:-translate-y-1 hover:border-emerald-500">      <div className="flex items-center gap-2 text-lg font-black">
...
{isEditing && (
  <form
    ...
    className="mt-3 rounded-xl bg-amber-50 p-3 grid gap-3"
  >
    <input
      type="hidden"
      name="match_id"
